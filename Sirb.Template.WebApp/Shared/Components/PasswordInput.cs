...
{
    public class PasswordInput : InputBase<string>
    {
        [Parameter] public string Label { get; set; }
        [Parameter] public bool ShowPassword { get; set; }
        [Parameter] public string Placeholder { get; set; }

        private const string ShowAsText = "text";
        private const string ShowAsPassword = "password";
        ...
        private void CreateInput(RenderTreeBuilder builder)
        {
            ...
            builder.AddAttribute(9, "type", PasswordVisibility());
        ...
        private string PasswordVisibility() => ShowPassword ? ShowAsText : ShowAsPassword;
    }
}
